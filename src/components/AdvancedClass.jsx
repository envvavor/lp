import { FaCalendar, FaCity, FaClock, FaMoneyBill } from "react-icons/fa";
import "../App.css";
      ...
      <div className="container">
        <div className="class-container">
          ...
          <div className="class-info">
            ...
            <div className="class-date"><FaCalendar />9 AGUSTUS 2025</div>
            <div className="class-time"><FaClock /> 09.00 - 17.00 WIB</div>
            <div className="class-location"><FaCity /> YOGYAKARTA</div>
            <div className="class-location"><FaMoneyBill /><b>Rp. 1.500.000</b></div>
          </div>
